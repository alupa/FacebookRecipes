...
public class RecipeListActivityTest extends BaseTest {
    ...
    public void setUp() throws Exception {
        ...
        RecipeListActivity recipeListActivity = new RecipeListActivity(){
            ...
            public RecipesAdapter getAdapter() { return adapter; }
    ...
    @Test
    public void testOnRecyclerView_ShouldChangeScrollPosition() throws Exception {
    ...
    private void setUpShadowAdapter(int positionToClick){
        ...
        RecyclerView recyclerView = (RecyclerView)activity.findViewById(R.id.recyclerView);
        RecipesAdapter adapterPopulated = new RecipesAdapter(imageLoader, onItemClickListener, recipeList);
